...
copy_runtime_core() {
  ...
  mkdir -p "$destination/Licenses/Visual"
  cp "$TUFREPLAY_PROJECT_ROOT/TUFReplay/Visual/Assets/Jipper/LICENSE.txt" "$destination/Licenses/Visual/JipperResourcePack.txt"
  cp "$TUFREPLAY_PROJECT_ROOT/TUFReplay/Visual/Assets/Fonts/"*-LICENSE.txt "$destination/Licenses/Visual/"
